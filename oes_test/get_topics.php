...
<body>
        ...
        <div class="container">
            ...
            if ($result->num_rows > 0) {
                ...
                while ($row = $result->fetch_assoc()) {
                    ...
                    echo '<td><a href="edit_topic.php?id=' . $row['id'] . '" class="btn btn-success">Edit</a></td>';
                ...
                echo "No topics found for the specified class and subject.";
            }
    ...
    function confirmDelete(topicId) {
        ...
        if (confirmation) {
            // User clicked "OK" (Yes)
            // Submit a form to delete the topic
            var form = document.createElement('form');
            form.method = 'post';
            form.action = 'delete_topic.php'; // Replace with the actual delete script

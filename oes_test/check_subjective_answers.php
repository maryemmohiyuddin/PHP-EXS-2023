    ...
    if (isset($_GET["user_id"]) && isset($_GET["topic_id"])) {
        ...
        if ($stmt->execute()) {
            ...
            if ($studentResult->num_rows === 1) {
                ...
                $answersQuery = "SELECT s.question, ssa.answer_text
                    FROM subjective s
                    JOIN student_subjective_answers ssa ON s.id = ssa.question_id
                    WHERE ssa.user_id = ? AND ssa.topic_id = ?";
                ...
                if ($stmt->execute()) {
                    ...
                    <head>
                        ...
                        <title>Check Subjective Answers</title>
                    ...
                    <body>
                        <div class="container mt-5">
                            <h1>Check Subjective Answers</h1>
                            <h3>Student:
                            ...
                            <?php } else { ?>
                                <p>No subjective answers found for this student.</p>
                            <?php } ?>
                        </div>
                    ...
                    echo "Error fetching subjective answers: " . $conn->error;
                }
            } else {

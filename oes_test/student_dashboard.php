...
if (isset($_SESSION["user_id"]) && $_SESSION["type"] == "student") {
    // Student is logged in, so you can proceed with displaying the student dashboard
                    ...
                    <div class="col-md-4 col-sm-12">
                        <div class="card text-center">
                            <div class="card-body">
                                ...
                                <p class="card-text">Click here to view topics of your class and subject.</p>
                                <a href="topics.php" class="btn colored-btn">Go to List</a>
                            </div>
                        </div>
                    </div>
                    <div class="col-md-4 col-sm-12">
                        <div class="card text-center">
                            <div class="card-body">
                                ...
                                <p class="card-text">Click here to view results of your exams.</p>
                                <a href="results.php" class="btn colored-btn">Go to List</a>
                            </div>
                        </div>
                    </div>

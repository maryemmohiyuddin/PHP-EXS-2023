...
<body>
    ...
    <div class="content">
        ...
        <div class="container mt-5 ">
            <h2 class="pl-1 mb-4">Edit Topic</h2>
                ...
                <form method="post">
                    <div class="form-group">
                        ...
                        <textarea class="form-control" id="topic" name="topic"
                            rows="3"><?php echo $topicname; ?></textarea>
                    </div>


                    <button type="submit" class="btn colored-btn">Update Topic</button>
                </form>
            </div>
        </div>
    </div>
